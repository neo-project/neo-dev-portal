...
function Navbar() {
  ...
  return (
    <nav
      ref={navbarRef}
      style={{borderBottom:"1px solid #EDEEF0", height:"65px"}}
      className={clsx('navbar shadow-none', 'navbar--fixed-top', {
      ...
      <div className="navbar__inner  max-w-6xl twcontainer mx-auto">
        <div className="navbar__items">
          ...
          <Logo
            className="navbar__brand"
            imageClassName="navbar__logo h-7"
            titleClassName="navbar__title"
          />
